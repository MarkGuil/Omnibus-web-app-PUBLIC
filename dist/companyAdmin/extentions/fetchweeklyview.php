...
// echo '<script>alert('.$_POST['starttime'].')</script>';

if (isset($_POST['termid']) && $_POST['termid'] == '' && isset($_POST['busid']) && $_POST['busid'] != '' && isset($_POST['starttime']) && $_POST['starttime'] == '' && isset($_POST['endtime']) && $_POST['endtime'] == '') {
    $busid = $_POST['busid'];
    $result222 = $conn->query("SELECT a.id, a.origin, a.destination, a.departure_time, a.routeID, b.trip_date, b.tripID, b.busID FROM trip a RIGHT OUTER JOIN bus_trip b ON(a.id = b.tripID) WHERE a.companyID = $id AND b.busID = $busid");
...
} else if (isset($_POST['termid']) && $_POST['termid'] != '' && isset($_POST['busid']) && $_POST['busid'] == '' && isset($_POST['starttime']) && $_POST['starttime'] == '' && isset($_POST['endtime']) && $_POST['endtime'] == '') {
    $termid = $_POST['termid'];
    $result222 = $conn->query("SELECT a.id, a.origin, a.destination, a.departure_time, a.routeID, b.trip_date, b.tripID, b.busID FROM trip a RIGHT OUTER JOIN bus_trip b ON(a.id = b.tripID) WHERE a.companyID = $id AND b.terminalID = $termid");
    $tripss = $result222->fetch_all(MYSQLI_ASSOC);
    $times = "11:00 PM";
    $times2 = "11:59 PM";
    for ($x = 0; $x <= 23; $x++) {
