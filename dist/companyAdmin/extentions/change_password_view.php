            ...
            <div class="container contaciner-small mt-3">
                <form class="form" id="change_password" action="" method="Post" oninput='password2.setCustomValidity(password2.value != password1.value ? "Passwords do not match." : "")'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <input type="password" class="form-control" name="oldpassword" autocomplete="on" required>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-9">
                            <input type="password" class="form-control" name="password1" autocomplete="on" required>
                        </div>
                    </div>
                    <div class="row mt-2">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-9">
                            <input type="password" class="form-control" name="password2" autocomplete="on" required>
                        </div>
                    </div>
                    <button type="submit" class="btn btn-primary mt-3 float-right" name="change_password" form="change_password">Save Changes</button>
                </form>
            </div>
        </div>
    </div>
