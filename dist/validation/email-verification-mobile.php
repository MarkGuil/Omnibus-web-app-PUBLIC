<?php include('includes/customer_verification.php') ?>
<!DOCTYPE html>
<html>
...
<body class="">
    <div class="container container-small vertical-center bg-white px-4 py-5">
        ...
        <form class="mx-3 mb-5" method="POST">
            ...
            <?php if ($_SESSION['logged'] == 0) { ?>
                <input class="btn btn-primary mt-3 px-4" type="submit" name="verify_email_mobile" value="Verify Email">
            <?php } else { ?>
                <input class="btn btn-primary mt-3 px-4" type="submit" name="verify_email_conductor_mobile" value="Confirm">
            <?php } ?>
        </form>
    </div>
</body>
