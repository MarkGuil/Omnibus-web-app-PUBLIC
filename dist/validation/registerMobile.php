...
<body class="vh-100">
    <div class="d-flex align-items-center h-100 pt-5">
        <div class="container container-small vertical-center bg-white px-3 py-5">
            <div class="h1 text-center mb-3 mt-5 text-primary">Omnibus</div>
            ...
            <form class="mx-3 mb-4" action="" method="POST" oninput='password2.setCustomValidity(password2.value != password1.value ? "Passwords do not match." : "")'>
                ...
                <button type="submit" class="btn btn-primary w-100 mt-2 px-4" name="adduser_mobile"><b>Register</b></button>
            </form>
            <span style="font-size: .9em;">Already have an account? </span><a style="font-size: .9em;" href="loginMobile.php">Login</a>
        </div>
    </div>
