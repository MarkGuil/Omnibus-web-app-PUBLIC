...
<body class="vh-100">
    <div class="d-flex align-items-center h-100">
        <div class="container container-small vertical-center shadow-lg bg-white px-5 py-5">
            <div class="h1 text-center text-primary mb-5 mt-2"><a href="../index.php" class="text-decoration-none">Omnibus</a></div>
            <h5 class="mb-4 ml-2 text-primary">Login</h5>
            <form class="mx-3 mb-2" action="" id="login_user_a" method="POST">
            ...
            <form class="" action="" id="login_demo_a" method="POST">
                <input type="hidden" class="form-control" name="email" placeholder="Email" value="Demo" required>
            </form>
            <div class="mx-3 mb-5">
                <button type="submit" class="btn btn-primary  px-4" name="login_user" form="login_user_a"><b>Login</b></button>
                <span class="py-2 mt-2 px-3 fs-3"> or </span>
                <button type="submit" class="btn btn-outline-primary px-4" name="login_demo" form="login_demo_a"><b>Login as demo user</b></button>
            </div>
            <div class="mt-2 mx-3">
                <div class="mt-1">
                    <span style="font-size: .9em;">Don't have an account? </span><a href="registerb.php" style="font-size: .9em;">Register</a>
                </div>
                <div class="mt-3">
