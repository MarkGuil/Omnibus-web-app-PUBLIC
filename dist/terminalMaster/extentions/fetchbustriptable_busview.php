...
$column = array('id', 'route', 'date', 'time', 'fare', 'driver', 'conductor', 'assigned by');
...
if (isset($_POST['filter_bus']) && $_POST['filter_bus'] != '' && isset($_POST['filter_date_range']) && $_POST['filter_date_range'] != '') {
    ...
    $query .= 'AND trip_date BETWEEN "' . $operatesF . '" AND "' . $operatesE . '" AND busID = "' . $_POST['filter_bus'] . '"  AND terminalID = ' . $termID . ' ';
}
