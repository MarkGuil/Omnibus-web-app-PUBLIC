...
$result22 = $conn->query("SELECT * FROM employees WHERE id = '$custID'");
$profileDetails = $result22->fetch_all(MYSQLI_ASSOC);
    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components ml-1">
                ...
                <li class="nactive">
                    <a href="homeConductor.php" class="text-white"><i class="fas fa-home mr-2"></i> Home</a>
                </li>
            ...
            <ul class="list-unstyled CTAs">
                ...
                <form class="form-inline my-2 my-lg-0">
                    <?php if (isset($_SESSION['conductorname'])) : ?>
                        <a class="btn btn-danger p-2 w-100" href="registeredProfile.php?logout='1'">Logout</a>
                    <?php endif ?>
                </form>
        ...
        <div id="content">
            ...
            <!-- <?php echo $_SESSION['conductorname'] ?> -->
            <div class="container vertical-center px-5 pt-4 pb-2 shadow" style="background-color:#7B84FA">
                <?php foreach ($profileDetails as $detail) { ?>
                    ...
                    <div class="mt-1 text-center text-light">
                        <small><i class="fas fa-phone mr-1"></i> <?php echo $detail['contactNumber'] ?></small><br>
                ...
                <div class="rounded-top bg-light pt-4 pb-4 shadow">
                    ...
                    <form class="my-2 mt-5 my-lg-0 text-center">
                        <?php if (isset($_SESSION['customername'])) : ?>
                            <a class="btn btn-danger p-2 w-75" href="registeredHome.php?logout='1'">Logout</a>
                        <?php endif ?>
                    </form>
                </div>

                <!-- <div class="container bg-light pt-4 pb-2 rounded-bottom shadow " >
                        <ul >
                            <li class="font-weight-bold text-secondary " style="font-size: 15px;">HELLO</li>
                        </ul>
                </div> -->
            </div>
