        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled CTAs">
                ...
                <form class="form-inline my-2 my-lg-0">
                    <?php if (isset($_SESSION['conductorname'])) : ?>
                        <a class="btn btn-danger p-2 w-100" href="changeMNumber.php?logout='1'">Logout</a>
                    <?php endif ?>
                </form>
                    ...
                    <form class="mx-3 mb-3" action="" method="POST">
                        ...
                        <?php foreach ($profileDetails as $detail) { ?>
                            <div class="md-6 form-group ">
                                <label class="h6 text-muted">Contact Number</label> <?php // echo $detail['id']; 
                                                                                    ?>
                                <input type="hidden" class="form-control" name="cid" value="<?php echo $detail['id']; ?>" placeholder="Contact Number" maxlength="11" size="11" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>

                                <input type="text" class="form-control" name="cnumber" value="<?php echo $detail['contactNumber']; ?>" placeholder="Contact Number" maxlength="11" size="11" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                            </div>
                        <?php } ?>
