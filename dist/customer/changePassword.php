        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light " style="background-color: #3b55d9;">
                <div class="container-fluid">
                    <a class="navbar-brand text-light" href="registeredProfile.php"><i class="fas fa-arrow-left mr-2 ml-2"></i></a><b class="text-light mr-5">Change Password</b>
                    <div></div>
                </div>
                ...
                <div class="container container-small vertical-center bg-white px-4 py-4 shadow">
                    ...
                    <form class="mx-3 mb-3" action="" method="POST" oninput='password2.setCustomValidity(password2.value != password1.value ? "Passwords do not match." : "")'>
                        ...
                        <div class="md-6 form-group">
                            <label class="h6 text-muted">Current Password</label>
                            <input type="password" class="form-control" name="curentpassword" placeholder="Password" required>
                        </div>
                        <div class="md-6 form-group">
                        ...
                        <?php if ($custID == 'demo_account') { ?>
                            <button type="button" class="btn btn-primary mt-3 px-4" name="changePassword"><b>Update Password</b></button>
                        <?php } else { ?>
                            <button type="submit" class="btn btn-primary mt-3 px-4" name="changePassword"><b>Update Password</b></button>
                        <?php } ?>
                    </form>
                </div>
            </div>
