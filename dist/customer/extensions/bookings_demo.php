...
if (isset($_SESSION['demo_booking_table'])) {
    for ($a = 0; $a < count($_SESSION['demo_booking_table']); $a++) {
        ...
        if ($_SESSION['demo_booking_table'][$a]["booking_status"] == 'confirmed') {
            if (date("Y/m/d", strtotime($bookings[0])) == $datetime->format('Y/m/d')) {
                $counter++;
?>
...
?>
                <div class="container container-small bg-light shadow rounded py-2 px-2 my-3">
                    ...
                    <div class="row">
                        <div class="col">
                            <?php echo $_SESSION['demo_booking_table'][$a]["booking_status"]  ?>
                            <?php echo $_SESSION['demo_booking_table'][$a]['origin'] . ' - ' . $_SESSION['demo_booking_table'][$a]['destination'] ?>
                        </div>
                    </div>
                    <div class="row mt-2">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col">
                            ...
                            <?php
                            if ($_SESSION['demo_booking_table'][$a]['payment_status'] == 'not paid') {
                                echo '<small id="paystatus' . $a . '" class="font-weight-bold text-danger">' . $_SESSION['demo_booking_table'][$a]['payment_status'] . '</small>';
                            } else {
                                echo '<small id="paystatus' . $a . '" class="font-weight-bold text-success">' . $_SESSION['demo_booking_table'][$a]['payment_status'] . '</small>';
                            }
                            ?>
                        </div>
                    </div>
