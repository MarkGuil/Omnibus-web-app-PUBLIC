...
<body class="">
    <div class="container container-small vertical-center bg-white px-4 py-5">
        ...
        <form class="mx-3 mb-5" action="loginCustomer.php" id="login_user_a" method="POST">
        ...
        <div class="mx-3 mb-5">
            ...
            <button type="submit" class="btn btn-primary px-4" name="login_demo" form="login_demo_a"><b>Login as demo user</b></button> -->
        </div>
        <div class="mt-2">
            <a href="" style="font-size: .9em;">forgot password?</a><br>
            <div class="mt-1">
                <span style="font-size: .9em;">Don't have an account? </span><a href="registerCustomer.php" style="font-size: .9em;">Register</a>
            </div>
        </div>
    </div>
</body>
