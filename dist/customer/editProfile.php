...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container vertical-center px-5 pt-4 pb-4 shadow" style="background-color:#7390d5">
                <?php
            ...
            <div class="container px-3 mt-3">
                <div class="container container-small vertical-center bg-white px-4 py-4 shadow">
                    ...
                    <div class="form-group md-6 mx-1">
                        <label class="h6 text-muted font-weight-bold">Birthdate</label>
                        <input type="date" class="form-control" name="birthdate" value="" placeholder="Date" required>
                    </div>
                    <button type="button" class="btn btn-primary mt-3 px-4" name=""><b>Save</b></button>
                    <?php
                    if ($custID == 'demo_account') { ?>
                    <?php } else { ?>
                        <form class="mx-3 mb-3" action="" method="POST">
                            ...
                            foreach ($profileDetails as $detail) { ?>
                                ...
                                <div class="form-group md-6 mx-1">
                                    <label class="h6 text-muted font-weight-bold">Birthdate</label>
                                    <input type="date" class="form-control" name="birthdate" value="<?php echo $detail['birthdate']; ?>" placeholder="Date" required>
                                </div>
                            <?php } ?>
