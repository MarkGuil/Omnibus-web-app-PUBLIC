        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand-lg navbar-light " style="background-color: #3b55d9;">
                <div class="container-fluid">
                    <a class="navbar-brand text-light" href="registeredProfile.php"><i class="fas fa-arrow-left mr-2 ml-2"></i></a><b class="text-light mr-5">Change Email</b>
                    <div></div>
                </div>
                    ...
                    <form class="mx-3 mb-3" action="" method="POST">
                        ...
                        <?php if ($custID == 'demo_account') { ?>
                            <div class="md-6 form-group ">
                                ...
                                <input type="email" value="" class="form-control" name="" placeholder="Email" required>
                            </div>
                        ...
                        <?php } else { ?>
                            <?php foreach ($profileDetails as $detail) { ?>
                                <div class="md-6 form-group ">
                                    <label class="h6 text-muted">Email Address</label>
                                    <input type="email" value="<?php echo $detail['email'] ?>" class="form-control" name="email" placeholder="Email" required>
                                </div>
                            <?php } ?>
                            <button type="submit" class="btn btn-primary mt-1 px-4 w-100" name="changeEmail"><b>Continue</b></button>
                        <?php } ?>
                    </form>
                </div>
            </div>
