...
$result = $conn->query("SELECT * FROM user_partner");
$users = $result->fetch_all(MYSQLI_ASSOC);

$result1 = $conn->query("SELECT count(id) AS id FROM user_partner");
...
<body>
                ...
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                            <a class="dropdown-item active" href="homeAdminPartner.php">Registered List</a>
    ...
    <div class="container container-large mt-5 bg-white px-5 py-3 rounded shadow">
        <h5 class="mt-2 mb-3"><b>Registered Partner List</b></h5>
                            ...
                            <tbody>
                                <?php foreach ($users as $user) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="homeAdminPartner.php#mymodaledit" class="edit" data-bs-toggle="modal" data-userid="<?php echo $user['id']; ?>"><i class="material-icons text-success" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="frm" id="add_form" action="" method="Post">
                        ...
                        <input type="hidden" class="form-control" name="usertype" value="2">
                        <div class="form-group md-6">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form" id="edit_form" action="" method="Post">
                        ...
                        <!-- <span>Your Class code: </span> <span id="code"><?= $classCode; ?></span> -->
                        <button class="btn btn-success ml-3" type="submit" name="editpartner" form="edit_form">Save Changes</button>
                    </form>
                </div>
                <!-- <div class="modal-footer"> -->
                ...
                <div class="modal-body">
                    ...
                    <div class="float-right">
                        <form class="form" id="delete_form" action="" method="Post">
                            ...
                            <button type="submit" name="deletepartner" form="delete_form" class="btn btn-danger">Delete</button>
                        </form>
                    </div>
                </div>
            </div>
