...
$result = $conn->query("SELECT * FROM user_partner_admin");
...
<body>
    <nav class="navbar navbar-dark navbar-expand-lg bg-dark shadow-lg py-3 px-5 mb-5">
        ...
        <div class="collapse navbar-collapse ml-2 mt-1" id="navbarNav">
            <ul class="navbar-nav ">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="homeAdmin_CompanyAdmin.php">Company Accounts</a>
                </li>
                <!-- <li class="nav-item">
                    <div class="dropdown">
    ...
    <div class="container container-large mt-5 bg-white px-5 py-3 rounded shadow">
        <h5 class="mt-2 mb-3"><b>Company Accounts</b></h5>
                ...
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-6">
                                    <h5 class="text-secondary">Manage Company Account</h5>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <a href="#" class="btn btn-success col-4 " data-bs-toggle="modal" data-bs-target="#mymodal"><i class="material-icons">&#xE145;</i><span class="mx-auto">Add New Account</span></a>
                                </div>
                            </div>
                        </div>
                        <table class="table table-striped table-hover px-2">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-secondary">Company Address</th>
                                    <th class="text-secondary">Primary Contact</th>
                                    <th class="text-secondary">Company Contact Number</th>
                                    <th class="text-secondary">Email</th>
                                    <th class="text-secondary">Email Verification</th>
                                    <th class="text-secondary">Document sent</th>
                            ...
                            <tbody>
                                <?php foreach ($users as $user) : ?>
                                    <tr>
                                        ...
                                        <td id="companyAddress<?php echo $user['id']; ?>"><?php echo $user["companyAddress"] ?></td>
                                        <td id="fullname<?php echo $user['id']; ?>"><?php echo $user["fullname"] ?></td>
                                        <td id="connumber<?php echo $user['id']; ?>"><?php echo $user["contactNumber"] ?></td>
                                        <td id="email<?php echo $user['id']; ?>"><?php echo $user["email"] ?></td>
                                        <td id="verification<?php echo $user['id']; ?>"><?php echo $user["email_verified_at"] ?></td>
                                        <td id="fileName<?php echo $user['id']; ?>">
                                            <?php
                                            $fileC = $user["fileCount"];
                                            $fileV = $user["file_verified"];
                                            if ($fileC == 0) {
                                                echo "empty";
                                            } elseif ($fileC != 0 && $fileV == 0) {
                                                echo "Pending";
                                            } elseif ($fileC != 0 && $fileV == 1) {
                                                echo "Verified";
                                            }
                                            ?>
                                        </td>
                                        <td>
                                            ...
                                            $mvalue = $user['id'];
                                            $encrypted_id = base64_encode($mvalue . $scode);
                                            ?>
                                            <a href="company_admin_info.php?i=<?php echo $encrypted_id  ?>" class="edit" data-userid="<?php echo $user['id']; ?>"><i class="fas fa-file-alt text-success"></i></a>
                                            ...
                                            <a href="#" class="delete" onclick="deletecompany(<?php echo $user['id']; ?>)"><i class="fas fa-trash-alt"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                ...
                <div class="modal-body">
                    ...
                    <div class="float-right">
                        <form class="form" id="delete_form" action="" method="Post">
                            ...
                            <button type="submit" name="deletecompanyadminr" form="delete_form" class="btn btn-danger">Delete</button>
                        </form>
                    </div>
                </div>
            </div>
